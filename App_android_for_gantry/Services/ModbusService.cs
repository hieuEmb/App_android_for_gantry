...
namespace App_android_for_gantry.Services // Dung namespace de to chuc cau truc file code
{
    class ModbusService
    {
        ...
        public async Task<bool> ReadCoilAsBoolAsync(byte slaveId, ushort registerAddress)
        {
            ...
            bool[] coils = await Task.Run(() => _modbusMaster.ReadCoils(slaveId, registerAddress, 1));
